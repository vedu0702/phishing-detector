...
st.set_page_config(page_title="Threat-X Global Guard Pro", page_icon="🛡️", layout="wide")
...
def render_screenshot_preview(target_url):
    ...
    thumb_url = f"https://image.thum.io/get/width/1000/crop/900/viewport/1600x900/noanimate/{target_url}"
    thumb_url_full = f"https://image.thum.io/get/width/1600/crop/1440/viewport/1600x900/noanimate/{target_url}"
...
st.markdown("""
    ...
    div.block-container { padding-top: 1.4rem; position: relative; z-index: 1; max-width: 1150px; margin-left: auto; margin-right: auto; }
